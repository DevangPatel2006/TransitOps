...
const getPdfReportData = async (type) => {
  if (type === 'vehicles') {
    ...
    return { formatted, headers, title: 'Vehicles Fleet Report' };
  }
  ...
  if (type === 'drivers') {
    ...
    return { formatted, headers, title: 'Drivers registry Report' };
  }
  ...
  if (type === 'trips') {
    ...
    return { formatted, headers, title: 'Dispatch Trips Report' };
  }
  ...
  if (type === 'costs') {
    ...
    return { formatted, headers, title: 'Fleet Operational Costs Report' };
  }
  ...
  if (type === 'roi') {
    ...
    const headers = ['vehicle_id', 'registration_no', 'revenue', 'maintenance_cost', 'fuel_cost', 'acquisition_cost', 'roi'];
    return { formatted, headers, title: 'Vehicles ROI Report' };
  }

  throw new ApiError(400, 'Invalid export type for PDF. Must be one of vehicles, drivers, trips, costs, or roi.');
};
